...
namespace matcrm.data.Models.MollieModel.Profile.Response {
    public class ProfileResponse : IResponseObject {
        ...
        /// <summary>
        /// The industry associated with the profile's tradename or brand. See the matcrm.data.Models.MollieModel.Profile.CategoryCode 
        ...
        /// matcrm.data.Models.MollieModel.Profile.ProfileStatus class for a full list of known values.
        /// </summary>
    ...
    public class Review {
        /// <summary>
        /// The status of the requested profile changes. See the matcrm.data.Models.MollieModel.Profile.ReviewStatus 
        /// class for a full list of known values.
        /// </summary>
        public string Status { get; set; }
    }
