...
namespace matcrm.data.Models.MollieModel.Subscription {
    public class SubscriptionResponse : IResponseObject {
        ...
        /// See the matcrm.data.Models.MollieModel.Subscription.SubscriptionStatus class for a full list of known values.
        /// </summary>
        ...
        /// null if any of the customer's valid mandates may be used. See the matcrm.data.Models.MollieModel.Payment.PaymentMethod class
