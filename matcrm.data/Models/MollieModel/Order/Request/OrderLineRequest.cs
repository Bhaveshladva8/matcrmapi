...
namespace matcrm.data.Models.MollieModel.Order {
    public class OrderLineRequest {
        ...
        /// matcrm.data.Models.MollieModel.Order.OrderLineDetailsType class for a full list of known values.
        /// </summary>
        public string Type { get; set; }

        /// <summary>
        /// The category of product bought. See the matcrm.data.Models.MollieModel.Order.OrderLineDetailsCategory class
