...
using matcrm.data.Models.MollieModel.Order.Response;
...
namespace matcrm.data.Models.MollieModel.Order {
    public class OrderResponse : IResponseObject {
        ...
        /// matcrm.data.Models.MollieModel.Payment.PaymentMethod class for a full list of known values.
        /// </summary>
        ...
        /// <summary>
        /// The status of the order - See the matcrm.data.Models.MollieModel.Order.OrderStatus class for a full list of known values.
        /// </summary>
