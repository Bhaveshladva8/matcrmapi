namespace matcrm.data.Models.MollieModel.PaymentMethod.Pricing
{
    public class PricingResponse : IResponseObject {
        ...
        /// the Payments API. See the matcrm.data.Models.MollieModel.Payment.Response.CreditCardFeeRegion class for a full list of 
        /// known values.
        /// </summary>
