...
namespace matcrm.data.Models.MollieModel.Payment.Request {
    public class PaymentRequest {
        ...
        /// See the matcrm.data.Models.MollieModel.Payment.PaymentMethod class for a full list of known values.
        /// </summary>
        [JsonIgnore]
        ...
        /// payment(see also: Recurring). See the matcrm.data.Models.MollieModel.Payment.SequenceType class for a full list of known values.
        /// </summary>
