namespace matcrm.data.Models.MollieModel.Payment.Response {
    ...
    public class CreditCardPaymentResponseDetails {
        ...
        /// <summary>
        /// Not always available. – The card's target audience. See the matcrm.data.Models.MollieModel.Payment.Response.CreditCardAudience 
        ...
        /// matcrm.data.Models.MollieModel.Payment.Response.CreditCardLabel class for a full list of known values
        /// </summary>
        ...
        /// matcrm.data.Models.MollieModel.Payment.Response.CreditCardSecurity class for a full list of known values
        /// </summary>
        ...
        /// matcrm.data.Models.MollieModel.Payment.Response.CreditCardFeeRegion class for a full list of known values
        /// </summary>
        public string FeeRegion { get; set; }

        /// <summary>
        /// Only available for failed payments. Contains a failure reason code. See the 
        /// matcrm.data.Models.MollieModel.Payment.Response.CreditCardFailureReason class for a full list of known values
        /// </summary>
