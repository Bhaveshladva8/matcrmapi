...
using matcrm.data.Framework;
using matcrm.data.Models.MollieModel.Url;
using matcrm.service.Services.Mollie.Client;

namespace matcrm.service.Services.Client {
    public abstract class BaseMollieClient {
        public const string ApiEndPoint = "https://api.mollie.com/v2/";
        //public const string ApiKey = "test_wNMG8tNBM22mg6zxJWQmnBeQh7H4V6";
        //public const string ApiKey = OneClappContext.MollieApiKey.ToString();
        private readonly string _apiEndpoint = ApiEndPoint;
        private readonly string _apiKey = OneClappContext.MollieApiKey;
       ...
       protected virtual HttpRequestMessage CreateHttpRequest(HttpMethod method, string relativeUri, HttpContent content = null) {
        ...
        private string GetUserAgent() {
            const string packageName = "matcrm.data.NET";
